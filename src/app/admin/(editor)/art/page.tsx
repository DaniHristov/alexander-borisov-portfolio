...
export default async function AdminArt() {
  ...
  return (
    <section>
      <h1 className="mb-4 text-sm uppercase tracking-wide text-neutral-400">Art — arrange the grid</h1>
      <GridEditor gallery="art" initial={initial} />
    </section>
  );
}
